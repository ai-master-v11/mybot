...
# ==================================================================
# 🌌 1. DARK CYBER TERMINAL UI (AI MASTER V14 SUPREME)
# ==================================================================
...
# ==================================================================
# 🎙️ 6. AYAN HUMAN VOICE INTERACTION SYSTEM (HTML5 Web Speech)
# ==================================================================
st.markdown("""
    <div class="ayan-box">
        <div class="ayan-title">🎙️ AYAN - YOUR AI HUMAN PARTNER</div>
        <p style="font-size:13px; color:#8892b0; margin-top:5px;">
            Click below to speak with Ayan via Live Voice Interaction.
        </p>
    </div>
""", unsafe_allow_html=True)
