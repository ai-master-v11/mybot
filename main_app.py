...
# ==================================================================
# 🎙️ 6. UNIVERSAL LIVE VOICE ASSISTANT (AYAN AI CORE)
# ==================================================================
st.markdown("""
    <div class="ayan-box">
        <div class="ayan-title">🎙️ AYAN - SMART LIVE VOICE ASSISTANT</div>
        <p style="font-size:13px; color:#8892b0; margin-top:5px;">
            অন করুন এবং আপনার পছন্দের ভাষায় যেকোনো কিছু জিজ্ঞেস করুন।
        </p>
    </div>
""", unsafe_allow_html=True)
