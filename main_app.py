...
# ==================================================================
# 🎙️ 6. UNIVERSAL LIVE VOICE & AYAN AI CONTROLLER
# ==================================================================
st.markdown("""
    <div class="ayan-box">
        <div class="ayan-title">🎙️ AYAN - LIVE UNIVERSAL AI VOICE ASSISTANT</div>
        <p style="font-size:13px; color:#8892b0; margin-top:5px;">
            Start-এ ক্লিক করে মুখে কথা বলুন। আয়ান সরাসরি বাংলায় আপনার প্রশ্নের উত্তর বয়েসে দেবে।
        </p>
    </div>
""", unsafe_allow_html=True)
...
<div style="text-align: center; margin-top: 15px;">
    ...
    <p id="ayanStatus" style="color: #ffcc00; font-size: 14px; margin-top: 10px; font-weight: bold;">Status: System Ready (Click to talk to AYAN)</p>
...
if (SpeechRecognition) {{
    ...
    talkBtn.addEventListener('click', () => {{
        if (!isListening) {{
            ...
            ayanStatus.innerText = "Status: 🟢 Microphone Active... বলুন মাসুম ভাই!";
        }} else {{
            recognition.stop();
            isListening = false;
    ...
    recognition.onresult = (event) => {{
        ...
        let reply = generateAyanResponse(text);
...
function generateAyanResponse(query) {{
    let q = query.toLowerCase();

    if (q.includes("agent") || q.includes("এজেন্ট")) {{
        return "হ্যাঁ মাসুম ভাই, ৫০,০০০ এজেন্ট সক্রিয় আছে এবং প্রতি সেকেন্ডে ভোটিং করছে।";
    }} else if (q.includes("market") || q.includes("trade") || q.includes("signal") || q.includes("মার্কেট")) {{
        return "মাসুম ভাই, এখন মার্কেটে এনালাইসিস চলছে। কনফার্মেশন এলে আমি আপনাকে সংকেত দেব।";
    }} else if (q.includes("কেমন") || q.includes("আছো")) {{
        return "আমি খুব ভালো আছি মাসুম ভাই! আপনার কাজ কেমন চলছে?";
    }} else if (q.includes("ayan") || q.includes("আয়ান")) {{
        return "হ্যাঁ মাসুম ভাই বলুন, আমি আপনার সব কথা শুনতে পাচ্ছি।";
    }} else {{
        return "হ্যাঁ মাসুম ভাই, আমি আপনার বিষয়টি ভালোভাবে বুঝতে পেরেছি। আপনার যা কিছু জানার আছে আমায় জিজ্ঞেস করুন!";
    }}
}}
