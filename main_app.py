...
# ==================================================================
# 🎙️ 6. UNIVERSAL LIVE VOICE ASSISTANT (HYBRID VOICE CORE)
# ==================================================================
st.markdown("""
    <div class="ayan-box">
        <div class="ayan-title">🎙️ AYAN - SMART VOICE ASSISTANT</div>
        <p style="font-size:13px; color:#8892b0; margin-top:5px;">
            অন করুন এবং আপনার পছন্দের ভাষায় যেকোনো কিছু জিজ্ঞেস করুন। (Auto Voice Speak Enabled)
        </p>
    </div>
""", unsafe_allow_html=True)
...
<div style="text-align: center; margin-top: 15px;">
    ...
    <p id="ayanStatus" style="color: #ffcc00; font-size: 14px; margin-top: 10px; font-weight: bold;">Status: System Ready</p>
...
// Fallback Voice Logic (ElevenLabs -> Native Web Speech)
async function speakSmartVoice(text) {{
    ayanStatus.innerText = "Status: 🔊 কথা বলছে...";
    ...
    if (API_KEY !== "") {{
        try {{
            ...
            console.log("ElevenLabs failed, switching to native voice...", error);
        }}
    }}
